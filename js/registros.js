...
const submitInsertUsuario = function(){
    ...
    if (insertUsuario.user == true && insertUsuario.nombre == true && insertUsuario.apellido_p == true && insertUsuario.apellido_m == true && insertUsuario.correo == true && insertUsuario.telefono == true){
        $.ajax({
            url:"./db/queries.php",
            type:"POST",
            data:{
